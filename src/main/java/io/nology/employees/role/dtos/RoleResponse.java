...
public record RoleResponse(Long id, String name, SeniorityLevel seniorityLevel, Department department) {
    public static RoleResponse of(Role role) {
        return new RoleResponse(role.getId(), role.getName(), role.getSeniorityLevel(), role.getDepartment());
    }
